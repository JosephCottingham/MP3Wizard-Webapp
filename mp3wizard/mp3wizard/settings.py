"""
Django settings for mp3wizard project.
...
SECRET_KEY = 'dok8v_6y)zt_vxpoozuyus@p5rj6wi25d*dma4arg8xr-^jk*n'
...
WSGI_APPLICATION = 'mp3wizard.wsgi.application'
